...
public class AioTest {
    public static void main(String[] args) throws Exception {
        Path file = Paths.get("src/leetCode/io/out.txt");
...
class WriteToFile {
    public static void main(String[] args) throws Exception {
        AsynchronousFileChannel fileChannel = AsynchronousFileChannel.open(Paths.get("src/leetCode/io/out.txt"), StandardOpenOption.READ, StandardOpenOption.WRITE, StandardOpenOption.CREATE);
